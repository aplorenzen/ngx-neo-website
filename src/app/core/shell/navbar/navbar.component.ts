  ...
  clickOutside(event: any) {
    if (!this.elementRef.nativeElement.contains(event.target)) {
      if (this.navigation.nativeElement.classList.contains('show')) {
        ...
        // From https://stackoverflow.com/questions/30623825/how-to-use-jquery-with-angular?utm_medium=organic&utm_source=google_rich_qa&utm_campaign=google_rich_qa
